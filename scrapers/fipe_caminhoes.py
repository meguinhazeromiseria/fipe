...
# -*- coding: utf-8 -*-
"""
FIPE SCRAPER - CAMINHÕES (VERSÃO ROBUSTA COM UPLOAD INCREMENTAL)
...
def main():
    print("="*60)
    print("🚚 FIPE SCRAPER - CAMINHÕES (UPLOAD INCREMENTAL)")
    print("="*60)
    ...
    for idx_marca, marca in enumerate(marcas, 1):
        ...
        print(f"   💾 Backup JSON: {len(veiculos_total)} caminhões\n")
