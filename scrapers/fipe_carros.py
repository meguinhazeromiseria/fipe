...
"""
FIPE SCRAPER - CARROS
Extrai tabela FIPE de carros e envia para Supabase
"""
...
def main():
    ...
    for idx_marca, marca in enumerate(marcas, 1):
        ...
        print(f"   💾 Salvou {len(veiculos)} carros em {OUTPUT_FILE}")
    
    print(f"\n{'='*60}")
    print(f"✅ SCRAPING CONCLUÍDO: {len(veiculos)} carros")
